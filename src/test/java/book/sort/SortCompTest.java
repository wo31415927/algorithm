...
public class SortCompTest {
    ...
    protected List<BaseSort> sortList = Lists.newArrayList(new BaseSort() {
        @Override
    ...
    }, mergeSort, mergeSort1, quickSort, quickSampleSort, quickNonRecursionSort,quick3ParMedSort);
    ...
    public void comp() throws Exception {
        for (int i = 0; i < sortList.size(); i++) {
            ...
            System.out.println(sortList.get(i).name() + "耗时：" + (System.currentTimeMillis() - from) / 1000.0);
        }
    }
}
