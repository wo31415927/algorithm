...
public class AbstractSortTest {
  public static final LinkedList<Integer[][]> intList =
      new LinkedList<Integer[][]>(/*Lists.newArrayList(
  ...
  public void testSort(boolean needPrintArr) throws Exception {
    ...
    System.out.println(
        baseSort.getClass().getSimpleName() + "耗时：" + (System.currentTimeMillis() - from) / 1000.0);
    from = System.currentTimeMillis();
